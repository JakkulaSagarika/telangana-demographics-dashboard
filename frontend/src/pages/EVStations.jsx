...
export default function EVStations() {
  ...
  return <div className="stations-page">
    ...
    <section className="stations-kpi"><article><span>Total stations</span><strong>{stations.length}</strong><small>All imported charging records</small></article><article><span>Matching results</span><strong>{filtered.length}</strong><small>Based on your current filters</small></article><article><span>Districts covered</span><strong>33</strong><small>Locations in the source dataset</small></article><article><span>Operators</span><strong>{operators.length}</strong><small>Charging-network organizations</small></article></section>
